...
<form id="craapForm">
            ...
            <p>Dit formulier is een gebaseerd op deze <a href="https://udc.libguides.com/ld.php?content_id=49188566" target="_blank">bron</a></p>
            ...
            <div class="mb-3">
                ...
                <select class="form-control" id="currencyScore" name="currencyScore">
                    <option value="0">
            ...
            <div class="mb-3">
                ...
                <select class="form-control" id="relevanceScore" name="relevanceScore">
                    <option value="0">
            ...
            <div class="mb-3">
                ...
                <select class="form-control" id="authorityScore" name="authorityScore">
                    <option value="0">
                    ...
                    <option value="2">
                        2 - Ik kan de auteur en sponsor identificeren, maar merk op dat de
                        auteur niet veel ervaring of autoriteit heeft over het onderwerp.
                    </option>
                    <option value="3">
                        3 - Ik kan de auteur en sponsor identificeren, en de auteur toont
                        duidelijk veel ervaring en/of onderzoek over het onderwerp.
                    </option>
                </select>
            </div>
            ...
            <div class="mb-3">
                ...
                <select class="form-control" id="accuracyScore" name="accuracyScore">
                    <option value="0">
                        0 - Er is geen bewijs, slechts een mening of regelrechte vlammen.
                    </option>
                    <option value="1">
                    ...
                    <option value="2">
                        ...
                        duidelijk zien dat de auteur het bewijs heeft verkeerd begrepen,
                        verkeerd gebruikt of cherry-picked.
                    </option>
                    <option value="3">
                        3 - De auteur gebruikt uitgebreid, hoogwaardig bewijs dat volledig
                        is geciteerd/gelinkt en wanneer ik ernaar kijk, heeft de auteur het
            ...
            <div class="mb-3">
                ...
                <select class="form-control" id="purposeScore" name="purposeScore">
                    <option value="0">
                        0 - Het doel van de bron is om emoties te ontvlammen of
        ...
        <h3 class="mt-5">Totaal: <span id="totalScore"></span></h3>
```
