...
3.  {{< fa network-wired >}} **Interne processen**: Dit kan worden verbonden met operationele modellen, zoals het [Total Quality Management (TQM)](https://youtu.be/F5vtCRFRAK0?si=j165x-O4V3CiWAix){target="_blank"} voor het verbeteren van de kwaliteit van processen en producten.
